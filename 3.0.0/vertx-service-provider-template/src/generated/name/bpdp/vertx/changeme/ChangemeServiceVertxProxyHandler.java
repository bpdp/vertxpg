...
*/
public class ChangemeServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final ChangemeService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public ChangemeServiceVertxProxyHandler(Vertx vertx, ChangemeService service) {
  ...
  public ChangemeServiceVertxProxyHandler(Vertx vertx, ChangemeService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
