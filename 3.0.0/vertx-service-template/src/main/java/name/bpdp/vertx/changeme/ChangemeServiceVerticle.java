...
public class ChangemeServiceVerticle extends AbstractVerticle {
	...
	public final static String ADDRESS = "vertx.changeme";

	private ChangemeService service;

    @Override
    public void start(Future<Void> startFuture) throws Exception {
		service = ChangemeService.create(config());
		String address = config().getString("address", ADDRESS);
		ProxyHelper.registerService(ChangemeService.class, vertx, service, address);
